                ...
                <div ref={profileRef} className="relative">
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 top-full w-64 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 mt-2 z-50">
                      ...
                      {/* Menu Items */}
                      <div className="py-1">
                        <Link href="/profile" className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition-colors">
